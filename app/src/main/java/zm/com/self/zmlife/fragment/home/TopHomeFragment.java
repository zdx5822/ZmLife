...
public class TopHomeFragment extends Fragment {
    @InjectView(R.id.act_recycler_variety_recycler_top)
    RecyclerView actRecyclerVarietyRecycler;
    @InjectView(R.id.refreshLayout_top)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_tophome, container, false);
