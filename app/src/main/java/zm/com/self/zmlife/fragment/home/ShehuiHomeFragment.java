...
public class ShehuiHomeFragment extends Fragment {
    @InjectView(R.id.act_recycler_variety_recycler_shehui)
    RecyclerView actRecyclerVarietyRecyclerShehui;
    @InjectView(R.id.refreshLayout_shehui)
    SmartRefreshLayout refreshLayoutShehui;
    RefreshLayout isrefreshLayout;
    boolean flag = false;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_shehuihome, container, false);
        ButterKnife.inject(this, view);
        refreshLayoutShehui.setOnRefreshListener(new OnRefreshListener() {
            @Override
        ...
        refreshLayoutShehui.setOnLoadMoreListener(new OnLoadMoreListener() {
            @Override
        ...
        refreshLayoutShehui.setRefreshHeader(new ClassicsHeader(getContext()));//.setEnableHorizontalDrag(true)
        //设置 Footer 为 球脉冲 样式
        refreshLayoutShehui.setRefreshFooter(new BallPulseFooter(getContext()).setSpinnerStyle(SpinnerStyle.Scale));
        getMessage();
        return view;
    }
    private void initViewOper(final List<HeadLineModel> headLineModelList) {
        ...
        actRecyclerVarietyRecyclerShehui.setLayoutManager(linearLayoutManager);
        actRecyclerVarietyRecyclerShehui.addItemDecoration(new DividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL));
        HomeAdapter adapter = new HomeAdapter(headLineModelList, getContext());
        actRecyclerVarietyRecyclerShehui.setAdapter(adapter);
